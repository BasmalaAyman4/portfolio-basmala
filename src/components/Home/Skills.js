...
import shape from '../../assets/skillcard.png'
const Skills = () => {
    return (
        <>
                    ...
                    <div className={`${styles.cards}`}>
                        <div className={`${styles.skill__card}`}>
                            <div className={`${styles.card__shape}`}>
                                <img alt='' src={shape} />
                                <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.svg}`} fill="#384BFF" version="1.1" id="Capa_1" width="35px" height="35px" viewBox="0 0 35.033 35.033" >
                                    <g>
                        ...
                        <div className={`${styles.skill__card}`}>
                            <div className={`${styles.card__shape}`}>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" className={`${styles.svg}`} width="35px" height="35px" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5 9.5C5 7.01472 7.01472 5 9.5 5C11.9853 5 14 7.01472 14 9.5C14 11.9853 11.9853 14 9.5 14C7.01472 14 5 11.9853 5 9.5Z" fill="#384BFF" />
                                    <path d="M14.3675 12.0632C14.322 12.1494 14.3413 12.2569 14.4196 12.3149C15.0012 12.7454 15.7209 13 16.5 13C18.433 13 20 11.433 20 9.5C20 7.567 18.433 6 16.5 6C15.7209 6 15.0012 6.2546 14.4196 6.68513C14.3413 6.74313 14.322 6.85058 14.3675 6.93679C14.7714 7.70219 15 8.5744 15 9.5C15 10.4256 14.7714 11.2978 14.3675 12.0632Z" fill="#384BFF" />
                                    ...
                                    <path d="M14.8185 14.0364C14.4045 14.0621 14.3802 14.6183 14.7606 14.7837V14.7837C15.803 15.237 16.5879 15.9043 17.1508 16.756C17.6127 17.4549 18.33 18 19.1677 18H20.9483C21.6555 18 22.1715 17.2973 21.9227 16.6108C21.9084 16.5713 21.8935 16.5321 21.8781 16.4932C21.5357 15.6286 20.9488 14.9921 20.0798 14.5864C19.2639 14.2055 18.2425 14.0483 17.0392 14.0008L17.0194 14H16.9997C16.2909 14 15.5506 13.9909 14.8185 14.0364Z" fill="#384BFF" />
                                </svg>
                            </div>
